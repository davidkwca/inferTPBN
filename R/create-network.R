...
##' @title Turns BoolNet network into threshold PBN.
##' @description Takes a BoolNet network and add threshold parameters as well
##'   associated logic functions to it.
##' @param net A network generated by \code{\link{createNetwork}}.
##' @param p Noise strength.
##' @return A threshold PBN.
##' @examples \dontrun{transformNetwork(net)}
...
##' @title Threshold parameters for genes.
##' @description Associates with each regulatory set of genes a vector
##'   determining whether said genes have a positive or negative effect.
##' @param net The network to be transformed.
##' @return The network with associated parameters.
##' @examples \dontrun{A(net)}
A <- function(net){
...
##' @title Boolean functions from threshold parameters.
...
##' @title Generate a number of synthetic timeseries from a network.
...
##' @title Predict value of gene at next step given current values.
##' @description Used only for \code{\link{simulateNetwork}}.
